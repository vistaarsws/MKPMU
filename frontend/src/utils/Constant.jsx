...
import projectHighlight_icon8 from "../assets/images/projectHighlight_icon8.svg";
...
const ministerQuoteSlides = [
  {
    ...
    ministerQuote: [
      ...
      "यह हमारी उन महिलाओं के लिए एक महान सेवा है, जिन्हें लंबी दूरी से पानी लाने में काफी कठिनाइयों का सामना करना पड़ता है।",
    ],
...
const actual_testimonials = [
  writtenTestimonials.writtenTestimonial_1,
  writtenTestimonials.writtenTestimonial_2,
  writtenTestimonials.writtenTestimonial_3,
  writtenTestimonials.writtenTestimonial_4,
  writtenTestimonials.writtenTestimonial_5,
  writtenTestimonials.writtenTestimonial_6,
  writtenTestimonials.writtenTestimonial_7,
  writtenTestimonials.writtenTestimonial_8,
  writtenTestimonials.writtenTestimonial_9,
  writtenTestimonials.writtenTestimonial_10,
  writtenTestimonials.writtenTestimonial_11,
  writtenTestimonials.writtenTestimonial_12,
  writtenTestimonials.writtenTestimonial_13,
  writtenTestimonials.writtenTestimonial_14,
  writtenTestimonials.writtenTestimonial_15,
  writtenTestimonials.writtenTestimonial_16,
  writtenTestimonials.writtenTestimonial_17,
  writtenTestimonials.writtenTestimonial_18,
  writtenTestimonials.writtenTestimonial_19,
];
